...
public class PostgresDatabaseMetaDataTest {
    ...
    @Test
    public void getCatalogs_returnsOnlyOneCurrentlyConnectedDB() throws SQLException {
        //given
        ...
        assertEquals(DB_NAME_1, catalogNames.get(0));
    }
